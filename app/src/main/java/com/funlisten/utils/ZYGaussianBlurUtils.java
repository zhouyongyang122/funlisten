...
public class ZYGaussianBlurUtils {

    public static void GaussianBlurPic(Context context, Bitmap bitmap, View view) {
        if (bitmap == null) {
            return;
        }
//        if(Build.VERSION.SDK_INT > 16){
//            blur(mContext, bitmap, view, 50);//这个范围只在1-24？
//        }else {
        view.setBackgroundDrawable(new BitmapDrawable(context.getResources(), fastblur(bitmap, 40)));
//        }
    }

    @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
    private static void blur(Context context, Bitmap bkg, View view, float radius) {
