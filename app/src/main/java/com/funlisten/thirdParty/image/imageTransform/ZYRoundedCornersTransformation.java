package com.funlisten.thirdParty.image.imageTransform;
...
public class ZYRoundedCornersTransformation implements Transformation<Bitmap> {
  ...
  public ZYRoundedCornersTransformation(Context context, int radius, int margin) {
    this(context, radius, margin, CornerType.ALL);
  }

  public ZYRoundedCornersTransformation(BitmapPool pool, int radius, int margin) {
