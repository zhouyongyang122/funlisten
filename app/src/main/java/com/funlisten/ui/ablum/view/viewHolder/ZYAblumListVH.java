package com.funlisten.ui.ablum.view.viewHolder;
...
public class ZYAblumListVH extends ZYBaseViewHolder<ZYAblum> {
    ...
    @Override
    public void updateView(ZYAblum data, int position) {
        if (data != null) {
            mData = data;
