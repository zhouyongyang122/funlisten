...
public class ZYAlbumLoader extends CursorLoader {
    ...
    public ZYAlbumLoader(Context context, boolean showGif) {
        super(context);
    ...
    private ZYAlbumLoader(Context context, Uri uri, String[] projection, String selection,
